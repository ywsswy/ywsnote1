...
####raw bitmap base64图像还原
import base64
from PIL import Image
key = [0,0]
image_path = "hh"
img = Image.open("D:\\hh.bmp")
bitmap =img.tobytes()
#img2 = Image.frombytes("P",(238,107),bitmap)
#img2.show()
print(bitmap)
#img.show()
encrypted = []
